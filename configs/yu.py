...
default_sex = '''# Default configuration file for SExtractor 2.28.0
# EB 2024-09-27
#
...
PHOT_APERTURES   2.5, 3.75, 6.25, 7.5, 8.75, 12.5            # MAG_APER aperture diameter(s) in pixels
...
GAIN             0.0            # detector gain in e-
GAIN_KEY         GAIN           # keyword for detector gain in e-/ADU
PIXEL_SCALE      0.04            # size of pixel in arcsec (0=use FITS WCS info)
...
BACK_PEARSON     2.5            # Pearson's factor alpha >= 1
BACK_SIZE        21             # Background mesh: <size> or <width>,<height>
...
CHECKIMAGE_TYPE  BACKGROUND,-BACKGROUND,SEGMENTATION
                                ...
                                # or APERTURES
CHECKIMAGE_NAME  background.fits,bkg_sub.fits,segmentation.fits
...
sex_configs = {
    ...
    "gauss_3.0_7x7.conv": gauss_3_7x7,
